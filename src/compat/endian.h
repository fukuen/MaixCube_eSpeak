...
#	endif
#elif defined(K210)
#		define htobe16(x) ((x)>>8 & 0xFF | (x)<<8)
#		define htole16(x) (x)
#		define be16toh(x) ((x)>>8 & 0xFF | (x)<<8)
#		define le16toh(x) (x)
 
#		define htobe32(x) ((x)>>24 & 0xFF | (x)>>8 & 0xFF00 | (x)<<8 & 0xFF0000 | (x)<<24)
#		define htole32(x) (x)
#		define be32toh(x) ((x)>>24 & 0xFF | (x)>>8 & 0xFF00 | (x)<<8 & 0xFF0000 | (x)<<24)
#		define le32toh(x) (x)

#		define htobe64(x) ((x)>>56 & 0xFF | (x)>>40 & 0xFF00 | (x)>>24 & 0xFF0000 | (x)>>8 & 0xFF000000 | (x)<<8 & 0xFF000000 | (x)<<24 & 0xFF00000000 | (x)<<40 & 0xFF0000000000 | (x)<<56)
#		define htole64(x) (x)
#		define be64toh(x) ((x)>>56 & 0xFF | (x)>>40 & 0xFF00 | (x)>>24 & 0xFF0000 | (x)>>8 & 0xFF000000 | (x)<<8 & 0xFF000000 | (x)<<24 & 0xFF00000000 | (x)<<40 & 0xFF0000000000 | (x)<<56)
#		define le64toh(x) (x)
