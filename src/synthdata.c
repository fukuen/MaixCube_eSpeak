...
#ifdef K210
#include "dat_phondata.h"
#include "dat_phonindex.h"
#include "dat_phontab.h"
#include "dat_intonations.h"
#endif
...
#ifdef K210
	phoneme_tab_data = dat_phontab;
	phoneme_index = dat_phonindex;
	phondata_ptr = dat_phondata;
	tunes = dat_intonations;
#else
